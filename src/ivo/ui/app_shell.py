...
from ivo.ui.theme import BACKGROUND, BORDER, PRIMARY, SURFACE, TEXT_PRIMARY, TEXT_SECONDARY
...
class AppShell(QWidget):
    def __init__(self, parent: QWidget | None = None) -> None:
        ...
        self.stack.setStyleSheet(f"QStackedWidget {{ background: {BACKGROUND}; }}")
    ...
    def add_page(self, page_id: str, label: str, widget: QWidget) -> None:
        ...
        button.setStyleSheet(_navigation_button_style())
...
def _navigation_button_style() -> str:
    return f"""
    QPushButton {{
        text-align: left;
        padding: 10px 12px;
