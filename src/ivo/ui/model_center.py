...
class ModelCenter(QWidget):
    ...
    def __init__(
        ...
        *,
        ...
        self.config_library_title.setStyleSheet("font-size: 16px; font-weight: 700;")
        self.config_list = QListWidget()
        self.config_list.setMinimumWidth(260)
        ...
        self.config_summary_card.apply_button.setStyleSheet(PRIMARY_BUTTON_STYLE)
        ...
        self.editor_drawer.setStyleSheet(CARD_STYLE)
        ...
        self.content_type_edit = QLineEdit("美剧、日剧、韩剧、通用")
    ...
    def toggle_advanced_settings(self) -> None:
        ...
        self.toggle_advanced_button.setText("隐藏开发者源文件" if show else "显示开发者源文件")
    ...
    def _build_detail_panel(self) -> QWidget:
        ...
        self.config_detail_title.setStyleSheet("font-size: 16px; font-weight: 700;")
        ...
        validation = QFrame()
        validation.setStyleSheet(CARD_STYLE)
    ...
    def _build_editor_drawer(self) -> QWidget:
        ...
        drawer_title.setStyleSheet("font-size: 16px; font-weight: 700;")
        ...
        actions = QHBoxLayout()
        self.save_config_button.setStyleSheet(PRIMARY_BUTTON_STYLE)
        self.save_apply_button.setStyleSheet(PRIMARY_BUTTON_STYLE)
